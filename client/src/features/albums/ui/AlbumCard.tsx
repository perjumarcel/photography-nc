...
interface AlbumCardProps {
  album: AlbumDto;
  /** Optional cover URL — when missing, a neutral placeholder is rendered. */
  coverUrl?: string;
 ...
 */
export function AlbumCard({ album, coverUrl, categoryName }: AlbumCardProps): React.JSX.Element {
