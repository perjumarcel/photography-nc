...
const resources = {
  ro: {
    translation: {
      ...
      'contact.directTitle': 'Contact direct',
      'contact.actionCall': 'Sună',
      'contact.actionWhatsApp': 'WhatsApp',
      'contact.actionEmail': 'E-mail',
      'contact.actionInstagram': 'Instagram',
      'contact.responseExpectation': 'Răspund de obicei în 24 de ore lucrătoare.',
      'contact.privacyNote': 'Detaliile tale rămân private și sunt folosite doar pentru a răspunde solicitării.',
      'contact.formName': 'Nume',
      'contact.formEmail': 'E-mail',
      'contact.formPhone': 'Telefon',
      'contact.formEventType': 'Tip eveniment / ședință',
      'contact.formPreferredDate': 'Data preferată',
      'contact.formVenue': 'Locație / venue',
      'contact.formBudget': 'Buget estimativ (opțional)',
  ...
  en: {
    translation: {
      ...
      'contact.actionCall': 'Call',
      'contact.actionWhatsApp': 'WhatsApp',
      'contact.actionEmail': 'Email',
      'contact.actionInstagram': 'Instagram',
      'contact.responseExpectation': 'I usually reply within one business day.',
      'contact.privacyNote': 'Your details stay private and are used only to respond to your inquiry.',
      'contact.formName': 'Name',
      'contact.formEmail': 'E-mail',
      'contact.formPhone': 'Phone',
      'contact.formEventType': 'Event / session type',
      'contact.formPreferredDate': 'Preferred date',
      'contact.formVenue': 'Venue / location',
      'contact.formBudget': 'Estimated budget (optional)',
