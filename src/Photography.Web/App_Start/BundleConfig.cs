        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(
                new StyleBundle("~/Bundles/account-vendor/css")
                    ...
                    .Include("~/css/admin/materialize.css", new CssRewriteUrlTransform())
                    .Include("~/css/admin/style.css", new CssRewriteUrlTransform())
            ...
            bundles.Add(
                ...
                .Include("~/css/admin/materialize.css", new CssRewriteUrlTransform())
                .Include("~/css/admin/style.css", new CssRewriteUrlTransform())
                .Include("~/css/admin/themes/all-themes.css", new CssRewriteUrlTransform())
