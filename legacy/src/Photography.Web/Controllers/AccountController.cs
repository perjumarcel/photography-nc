...
using Photography.Web.Controllers.Results;
using Photography.Web.Models;
using Photography.Web.Models.Account;
...
{
    public class AccountController : PhotographyControllerBase
    {
        ...
        {
            if (!AbpSession.TenantId.HasValue || _tenantCache.GetOrNull(AbpSession.TenantId.Value) == null)
            {
                return null;
            }
        ...
        public async Task<PartialViewResult> TenantChangeModal()
        {
            ...
            {
                TenancyName = loginInfo.Tenant == null ? null : loginInfo.Tenant.TenancyName
            });
        }
